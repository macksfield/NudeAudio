...
function mailchimpSF_main_css() {
	?>
    #inner-newsletter-signup{position:relative;}
    #mc_signup_form{height:10px;ovelflow:visble;}
...
function mailchimpSF_signup_submit() {
	...
	if (count($errs) > 0) {
		...
		$msg = "<span class='mc_success_msg'>".esc_html(__("You've been signed up! Please look for our confirmation email", 'mailchimp_i18n'))."</span>";
	}
